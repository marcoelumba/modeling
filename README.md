...
2. Create a macro to calculate the date threshold dynamically:
   [View code](https://github.com/marcoelumba/modeling/blob/6b85fb4c071069529e701009431195366b1a478f/monorepo/macros/generic_utils.sql#L11)
    ```sql
...
3. Call the macro in `active_users.sql`:
    - Default threshold:
      [View code](https://github.com/marcoelumba/modeling/blob/6b85fb4c071069529e701009431195366b1a478f/monorepo/models/active_users.sql#L24)
      ```sql
...
[View code](https://github.com/marcoelumba/modeling/blob/6b85fb4c071069529e701009431195366b1a478f/monorepo/models/schema.yml#L8)
```yaml
models:
  - name: active_users
    columns:
...
- **Using `ROW_NUMBER` with Filtering:**
  ...
  [View code](https://github.com/marcoelumba/modeling/blob/6b85fb4c071069529e701009431195366b1a478f/monorepo/models/active_users.sql#L22)
  ```sql
  ROW_NUMBER() OVER (PARTITION BY customer_id ORDER BY last_booking_date DESC) AS row_num
  ```
  Then filter using:
  [View code](https://github.com/marcoelumba/modeling/blob/6b85fb4c071069529e701009431195366b1a478f/monorepo/models/active_users.sql#L34)
  ```sql
  WHERE row_num = 1
  ```
...
1. Inline call in `active_users.sql`:
   [View code](https://github.com/marcoelumba/modeling/blob/6b85fb4c071069529e701009431195366b1a478f/monorepo/models/active_users.sql#L1)
    ```sql
    {% apply_incremental_config('customer_id', 'last_booking_date') %}
    ```
2. Macro for reusability:
   [View code](https://github.com/marcoelumba/modeling/blob/6b85fb4c071069529e701009431195366b1a478f/monorepo/macros/generic_utils.sql#L16)
    ```sql
...
3. Add a 3-day lookback for delayed data ingestion:
   [View code](https://github.com/marcoelumba/modeling/blob/6b85fb4c071069529e701009431195366b1a478f/monorepo/models/active_users.sql#L11)
    ```sql
    {% if is_incremental() %}
...
1. Dynamic schema for development:
   [View code](https://github.com/marcoelumba/modeling/blob/6b85fb4c071069529e701009431195366b1a478f/monorepo/dbt_project.yml#L31)
    ```yaml
    +schema: >
...
2. Add user environment for dynamic schema in development to `profiles.yml`:
   [View code](https://github.com/marcoelumba/modeling/blob/6b85fb4c071069529e701009431195366b1a478f/monorepo/profiles.yml#L9)
    ```yaml
    dev:
